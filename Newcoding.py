...
\033[1;97m--------------------------------------------------
""")
	print("\t\x1b[1;92m [!] Your IP Address : \x1b[1;92m") + ip
...
def login():
	...
	try:
		...
		print("")
		token = raw_input("\n\033[1;97m[!] Enter Your Token : \033[0;90m")
		if token == "":
...
def menu():
	...
	print(" [3] Crack From Multi Account")
	print(" [4] See Crack Your Result")
	print(" [5] Check The Crack Result Option")
	print(" [6] Manage User-Agent")
...
def publik():
	...
	try:
		...
		exit(" [!] token expired")
	logo()
	print("\n [!] Fill In 'me' If You Want From Own FriendsList")
	print("")
	...
	try:
		...
		exit(" [!] Account Not Available OR Private FriendList")
...
def follower():
	...
	try:
		...
		exit(" [!] Account Not Available OR Private Followers")
	print(" [+] Total ID  : \033[0;91m%s\033[0;97m"%(len(id))) 
...
def massal():
	...
	try:
		...
		exit(" [!] token expired")
	try:
		tanya_total = int(raw_input(" [+] Enter Number Of Account Crack : "))
	except:tanya_total=1
	logo()
	print("\n [!] Fill In 'me' If You Want From Own FriendList")
...
def method():
	print(" \n [ Select Crack Method ]\n")
	print(" [1] Api Method \033[1;91m(Fast Crack)")
	print(" [2] Free Method \033[1;91m(Fast Crack)")
	print(" [3] Mbasic Method \033[1;91m(Slow Crack)")
	print(" [4] Mobile Method \033[1;91m(Slow Crack)")
	method = raw_input("\n [+] Choose Mehtod : ")
	if method == "":
		menu()
	elif method == "1":
